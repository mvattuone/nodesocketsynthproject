...
<script src="/socket.io/socket.io.js"></script> // load socket.io library
<script>
	var server = io.connect('http://localhost:8080'); // connect to our socket.io server
	server.on('messages', function(data) {
		insertMessage(data); // jQuery function to insert a message into chat box
	});
	$('#chat_form').submit(function(e) {
		var message = $('#chat_input').val();
		server.broadcast.emit('messages', message);
